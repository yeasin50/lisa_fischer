...
class ErrorPage extends StatelessWidget {
        ...
        builder: (context, constraints) {
          ...
          return Stack(
            children: [
              ...
              Align(
                child: _middleNeonRect(boxWidth, boxHeight),
              ),
  ...
  Widget _middleNeonRect(double boxWidth, double boxHeight) {
    //Better work on background color instead of using child background

    final TextStyle _textStyle = TextStyle(fontSize: 44, color: Colors.white);
