...
HashImageData get gshopShowCase => HashImageData(
      imageUrl:
      ...
      hash:
          "|KRfkAxuWFxvodR\$xaWB-;M|t7a#t7ayj@j[ogt7~qRQoeRia#ogRkocIU_3RjfORij[ogWBayIUM_ofWBofj@j?j[a#t79Ft7j]t7j@RiofRk%MxuofofoeWCa#ayt6j[-;WBj?WBWCogayofWBtRWBRjWBj?j[ayWBV@",
    );

//* on [P3Challenge2Solutions]

HashImageData get solution1Cover => HashImageData(
      imageUrl:
          "https://images.squarespace-cdn.com/content/v1/547fe426e4b0dc192edb1ed5/1590350017132-ZJWLDOX3GSITLN1K7GLT/ke17ZwdGBToddI8pDm48kBe3s72x4TW__9H-J8QPN6d7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0pQYXULvgm9t5Zb8hmAX2a-2QVMc0DOsEw99humzWVrFVBcZcfL7QrKE_xBa0lpg2Q/buy+on+google+images+for+portfolioo-12.png",
      hash:
          "g7RftfTN5wD\$XU~TtS~qIUM{-;RPRPRjT2V@n}t7V?ayWA%LV?WBt7X9kDog4:-:%1IUt7M|od",
    );

HashImageData get solution2Cover => HashImageData(
      imageUrl:
          "https://images.squarespace-cdn.com/content/v1/547fe426e4b0dc192edb1ed5/1593370185981-ZRTILUE0US7N72K1TZ70/ke17ZwdGBToddI8pDm48kPYL8vMf5MK395rQIEZQsvF7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0gkB-ogLx65Ep68Jc3FEurvoKLIolQEeIY4vOEJZJ4JJze7s2JxfUzCZ9mTlu3vZCA/roller+coaster-34-34-35-34-34.png",
      hash:
          "|DQmPE9h?IxXR.%NoaIUxusqo\$kBM_Rjt7RjoMxv~VIXWRM|%3t6IpxuRj9wM_xuxva{NGs.R*aJ?ZxCNL%1IUIo-pWFRQ-qE3M^t7xbxZW@oJM{oK%Ke-kDa#RjR%WAxvIVofs=oeRjWDxZV[ozxZWCf#RjofxuWFa#WA",
    );

HashImageData get solution3Cover => HashImageData(
      imageUrl:
          "https://images.squarespace-cdn.com/content/v1/547fe426e4b0dc192edb1ed5/1593371429717-399E6BX3HCYTCEBIW9KW/ke17ZwdGBToddI8pDm48kGttJQ3fNJjEPJpWvJxnJ5x7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0qRGAtipPmBDa-K0OI3D5BM_VNprNPjtsnKQ3_2ravThonCkQUqLkSQrXw9s6QjMPw/buy+on+google+_shoppping+actionss-higher+res-332-03-32.png",
      hash:
          "|3Qv|E%2yYcGxo-TMy\$,NE?vS\$aMv|R5S\$%zbcMdo\$nhs%T0IqnioJWT%f-qn\$kVS\$ogn~RijFt7tLS%M~v|%0Osb]s;IB-XnhX5OtyCr;DijY.7.mX9MJrqRoSjtQX4xu%Nnit6S\$Sio0nNnhS\$D\$jbxvWqo{obixnmIo",
    );

HashImageData get gshopOnWebSearch => HashImageData(
      imageUrl:
          "https://images.squarespace-cdn.com/content/v1/547fe426e4b0dc192edb1ed5/1593358472652-A6IP5T382DZ1A7XSILMP/ke17ZwdGBToddI8pDm48kAHWeGNrnTNuaaRsQC5iQLWLPZHY9930KFuik00L7GzBKdq8kyNB6kzmmlKIayPDyODNVAVoT5JWrLXnFZMIhf1eKxxnxAGk445uFOpsZm_-/image-asset.gif",
      hash:
...
HashImageData get gshopOnMobileSearch => HashImageData(
      imageUrl:
          "https://images.squarespace-cdn.com/content/v1/547fe426e4b0dc192edb1ed5/1593359373939-6PZMAHELDSJ4VAEKNIY9/ke17ZwdGBToddI8pDm48kAHWeGNrnTNuaaRsQC5iQLWLPZHY9930KFuik00L7GzBKdq8kyNB6kzmmlKIayPDyODNVAVoT5JWrLXnFZMIhf1eKxxnxAGk445uFOpsZm_-/image-asset.gif",
      hash:
...
//* [P4GShoppingActions]
HashImageData get merchantWebsiteMarketing => HashImageData(
      imageUrl:
